...
| GoDaddy domain | `a1quantumoracleai.com` registered (GoDaddy NS) and attached/verified on Vercel; DNS still points at GoDaddy placeholder A records (15.197.148.33 / 3.33.130.190) → **user must change nameservers (or A record to `76.76.21.21`) to Vercel** |
